...
!XIOS read restart   
   ...
   INTEGER, PARAMETER, PUBLIC                   :: max_rst_fields = 97 !: maximum number of restart variables defined in iom_set_rst_vars
...
!$AGRIF_END_DO_NOT_TREAT
   ...
   !! $Id: iom_def.F90 13280 2020-07-09 11:53:42Z smueller $
