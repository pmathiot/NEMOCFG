...
NOLEG=`tail -1 ${CONFIG_CASE}.db | awk '{print $1}' `
LOGFILE=nemo.${NOLEG}
case  $MACHINE  in
( occigen | jean-zay ) SUBMIT="sbatch -e ${LOGFILE}.e%j -o ${LOGFILE}.o%j -J ${LOGFILE}" ;;
...
F_FOR_DIR=${SDIR}/${CONFIG}/${CONFIG}-I/JRA55_ano_22602299-19752014_cycle2    # in function 3.2
...
P_FOR_DIR=$DDIR/${CONFIG}/${CONFIG}-I/JRA55_ano_22602299-19752014_cycle2        # forcing files
...
# Control parameters
# -----------------
MAXSUB=100              # resubmit job till job $MAXSUB
