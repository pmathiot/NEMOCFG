...
!       <CN_ICBRST_INDIR>.<<nn_no-1>>/<CN_ICBRST_IN>-<<nn_no -1 >>_<RANK>.nc
      ...
      !       <CN_ICBRST_INDIR>.<<nn_no>>/<CN_ICBRST_IN>-<<nn_no  >>_<RANK>.nc
