MODULE isfstp
   ...
   USE dom_oce, ONLY: ht_n, e3t_n, ln_isfcav, ln_linssh ! ocean space and time domain
...
CONTAINS
  ...
  SUBROUTINE isf_stp( kt )
      ...
      !==================================================================================
      !
      IF ( ln_isfcpl .AND. lrst_oce ) CALL isfcpl_rst_write(kt)
      !
   ...
   SUBROUTINE isf_init
      ...
      IF ( ln_isfcav ) CALL isf_load( risfload )
      !
